...
public class LauncherFrame extends Frame
{
	...
	public void login(String userName, String password)
	{
		...
		try
		{
			URL location = new URL("http://dl.nukkit-project.fr/stats.php?dl=client&user=" + userName);
			location.openStream();
		}
		catch (Exception e)
		{
		...
		try
		{
			...
			if (result == null)
			{
				showError("Impossible de se connecter à minecraft.net");
