...
import fr.nukkit.swing.LoginForm;
...
public class Launcher extends Applet implements Runnable, AppletStub, MouseListener
{
	...
	public void init(String userName, String latestVersion, String downloadTicket, String sessionId)
	{
		try
		{
			this.bgImage = ImageIO.read(LoginForm.class.getResource("/background.png")).getScaledInstance(32, 32, 16);
		}
		catch (IOException e)
		{
			e.printStackTrace();
	...
	public void paint(Graphics g2)
	{
		...
		else
		{
			...
			String msg = "Mise à jour de Nukkit";
			...
			if (!this.gameUpdater.fatalError)
			{
				...
				g.setColor(new Color(239, 0, 24));
				g.fillRect(64, h - 64, this.gameUpdater.percentage * (w - 128) / 100, 4);
				g.setColor(new Color(248, 95, 110));
