...
import fr.nukkit.core.GameUpdater;
import fr.nukkit.core.Util;
...
public class OptionsPanel extends JDialog
{
	...
	public OptionsPanel(Frame parent)
	{
		...
		labelPanel.add(new JLabel("Forcer la mise à jour de Nukkit  : ", 4));
		fieldPanel.add(forceButton);

		labelPanel.add(new JLabel("Emplacement des fichiers de Nukkit : ", 4));
